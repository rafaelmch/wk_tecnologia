...
begin
  ...
  //Attachment := TIdAttachmentFile.Create(nil);

  //obs: minha versão de Delphi não tem esse componente (para anexar arquivo)
  //anexando arquivo
  //Attachment := TIdAttachmentFile.Create(data.MessageParts, 'c:\temp\Cadastro.xml');
